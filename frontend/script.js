...
function calculateGpa(){
    ...
    if(addedCategories == null || addedCategories.length == 0){
        ...
        if(totalPercentage != 100){
            return alert("The sum of all exams")
        }
    }else{
    ...
    var gpa = round((result*4)/100, 2);
    $(".total-information").append(`
        <span class="font-s-14 bold">Percentage: </span><span class="font-s-14" >${result}</span><br/>
        <span class="font-s-14 bold">GPA: </span><span class="font-s-14" >${gpa}</span><br/>
    `)
